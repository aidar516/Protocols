...
internal class UdpManager(private val context: Context): StreamManager {
    private val TAG = "UdpManager"

    private var exoPlayer: ExoPlayer? = null
    private var playerView: PlayerView? = null
    private var currentVideoThread: VideoThread.UDP? = null
    ...
    override fun start(videoThread: VideoThread, onStatusChanged: (StreamStatus) -> Unit) {
        ...
        if(videoThread !is VideoThread.UDP){
            throw Exception("This not udp thread video")
        }
